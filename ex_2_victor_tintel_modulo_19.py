...
def main():
    ...
    st.set_page_config(page_title = 'Telemarketing analisys', \
        page_icon = "C:\\Users\\victo\\OneDrive\\Área de Trabalho\\Ciências de Dados\\5 - Desenvolvimento Modelos com Pandas e Python\\Módulo 19 - Streamlit II\\img\\telmarketing_icon.png",
        layout="wide",
    ...
    image = Image.open("C:\\Users\\victo\\OneDrive\\Área de Trabalho\\Ciências de Dados\\5 - Desenvolvimento Modelos com Pandas e Python\\Módulo 19 - Streamlit II\\img\\Bank-Branding.jpg")
    st.sidebar.image(image)

    bank_raw = pd.read_csv("C:\\Users\\victo\\OneDrive\\Área de Trabalho\\Ciências de Dados\\5 - Desenvolvimento Modelos com Pandas e Python\\Módulo 19 - Streamlit II\\data\\input\\bank-additional-full.csv", sep=';')
